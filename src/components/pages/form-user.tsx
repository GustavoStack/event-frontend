export default function FormUser() {
    return (
        <div className="w-full flex justify-center items-center min-h-screen bg-background">
            <form className="bg-white p-6 rounded-2xl shadow-lg w-full max-w-lg">
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                            First Name
                        </label>
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="First..." />
                    </div>
                    <div className="w-full md:w-1/2 px-3">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                            Last Name
                        </label>
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="Last..." />
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <button className="bg-button hover:bg-gray-800 text-white font-bold py-2 px-4 rounded hover:cursor-pointer inline-flex items-center">
